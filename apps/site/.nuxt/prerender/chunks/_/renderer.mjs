import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, joinURL } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/vue/server-renderer/index.mjs';
...
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/devalue/index.js';
import { walkResolver } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/unhead/dist/plugins.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Autonomous software delivery on Kubernetes with orchestrated AI drones, built-in Forgejo, Keycloak, and deployable Helm charts."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Vinculum"};
