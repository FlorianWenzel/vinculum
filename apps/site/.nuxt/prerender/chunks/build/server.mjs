...
import { $fetch } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/florian/projects/vinculum/apps/site/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "docs",
    path: "/docs",
    component: () => import('./docs-DDmjJzES.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DA7XwErw.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bgo2V5mF.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-1CsNo5QY.mjs'));
