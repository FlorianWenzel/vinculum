...
Operational meaning:
- Installing chart version `0.4.1` uses app images tagged `0.4.1` by default.
...
```bash
helm install vinculum oci://ghcr.io/florianwenzel/helm/vinculum --version 0.4.1 -n vinculum-system --create-namespace
```
